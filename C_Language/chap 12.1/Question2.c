...
//     printf("Enter How many Employeees are Working \t:");
//     scanf("%d", &n);
...
//     printf("\n");
//     printf("Employeee's Company Name:\n");
//     for (i = 0; i < n; i++)
//     {
